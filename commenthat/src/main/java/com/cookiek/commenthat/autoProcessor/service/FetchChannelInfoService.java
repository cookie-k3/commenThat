...
public class FetchChannelInfoService {
    ...
    public FetchChannelInfoService(WebClient.Builder webClientBuilder, UserInterface userInterface, ChannelInfoInterface channelInfoInterface) {
    ...
    public void fetchChannelInfoAsync(String channelId, Long userId) {
        try {
